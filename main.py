...
def init_parser():
    ...
    parser.add_argument('--itemrename', '-ir', help='rename item to its description', default=True, action='store_true')
    parser.add_argument('--eventrename', '-er', help='rename event to its description', default=True, action='store_true')
