 ...
 */
class Dataset(val header: DatasetMeta, val data: Map[String, Event], val patients: Array[Array[String]]) {
  ...
  def this(header: DatasetMeta, data: Array[Array[String]]) = {
    this(header, {
  ...
  def this(header: DatasetMeta, data: Array[Array[String]], pat: Array[Array[String]]) = {
    this(header, {
